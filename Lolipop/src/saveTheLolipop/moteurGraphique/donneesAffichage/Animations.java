...
public class Animations {
	public static Coordonnees deplacementSimple(Coordonnees coord, Float Vit, int delta) {
		...
		if (GestionnaireClavierSouris.enMouvementGauche) x -= Vit * delta;
		if (GestionnaireClavierSouris.enMouvementDroit) x += Vit * delta;
		
		if (GestionnaireClavierSouris.enMouvementHaut) y -= Vit * delta;
		if (GestionnaireClavierSouris.enMouvementBas) y += Vit * delta;
